...
/**
 * The customer's own account — `/app/customer/profile`. Direct copy of
 * `admin/profile/page.tsx`'s structure — every field here is "me"-scoped and
 * role-agnostic, so this is a shell/crumbs swap plus dropping the "why role
 * and status are read-only" aside note (an admin editing their own role is a
 * lockout risk; a customer's role is not admin-editable from here either way).
 */
...
const NOTICES: Record<string, Notice> = {
  ...
  profile_forbidden: {
    tone: 'error',
    text: 'Your account is not allowed to edit its own profile.',
  },
  ...
  session_failed: { tone: 'error', text: 'We could not end that session. Try again in a moment.' },
}
          ...
          >
            ...
            >
              ...
              >
                ...
                <PhoneNumberField id="phone" defaultValue={profile.phone} required />
